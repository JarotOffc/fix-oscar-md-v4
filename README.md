...
- Owner Number [Here](https://github.com/Alpiii22/fix-oscar-md-v4/blob/master/config.js#L1)
- Owner Name [Here](https://github.com/Alpiii22/fix-oscar-md-v4/blob/master/config.js#L1)
- Bot Name [Here](https://github.com/Alpiii22/fix-oscar-md-v4/blob/master/config.js#L1)
---------
...
$ git clone https://github.com/Alpiii22/fix-oscar-md-v4
$ cd fix-oscar-md-v4
$ npm i 
```
...
## ```Recode By ✏️```
[![JAROT](https://github.com/JarotOffc.png?size=150)](https://github.com/JarotOffc)
